            ...
            const resetCards = (addTries = true) => {
                ...
                cardElements.forEach((card) => {
                    ...
                    if (!card.getAttribute('anoixthcarta') && card.savedText != '∞' && !card.mazeWall) {
                        ...
                        if (dimensionsModeEnabled && card.savedBackgroundColor.includes(dimensionColors[activeDimension])) {
            ...
            (() => {
                ...
                const winCheckLoop = (openedCards) => {
                    ...
                    if (
                        ...
                        // Αν δεν είναι VOID mode ή Papagianneos Finale.
                        if (voidModeOver && !BLOCK_WIN) {
